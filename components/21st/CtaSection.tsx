...
export function CtaSection({ title, description, showButtons = false }: CtaSectionProps) {
  return (
    <div className="relative mx-auto flex w-full max-w-3xl flex-col justify-between gap-y-6 border-y bg-[radial-gradient(35%_80%_at_25%_0%,rgba(0,0,0,0.08),transparent)] px-4 py-8">
      <PlusIcon
